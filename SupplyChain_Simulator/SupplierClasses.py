...
class Supplier:
    ...
    def __init__(self, Label, Lat, Long,
                 ...
                 ProdFailure, Horizon, CurrentUnMet, ShipmentList_PRE, ShipmentList_POST,
                 thetas, KI, KO, KPro, KPur, Value, Margin): # Last line: Parameters
        self.Label = Label
        self.Lat = Lat
        self.Long = Long
        ...
        self.ShipmentList_PRE = ShipmentList_PRE # Current shipments which have NOT stored in inventory YET Pre Update
        self.ShipmentList_POST = ShipmentList_POST # Current shipments which have NOT stored in inventory YET Post Update
        ...
        self.Value = Value # The total value of all materials per produced part, if zero children = 1
        self.Margin = Margin # produced part value-materials value (mark up)
    ##########################################
    # Methods
...
class LocalShipment:
    ...
    def LocalShipmentUpdate(self, Supplier):
        ...
        if self.DayCounter == -1:
            ...
            Supplier.ShipmentList_PRE.remove(self)          
###############################################################################